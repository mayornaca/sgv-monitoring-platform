...
use sgv\DashboardBundle\Entity\Tbl17Proveedores;
use sgv\DashboardBundle\Form\Tbl17ProveedoresType;
...
class SuppliersController extends BaseController
{
    ...
    public function indexAction(Request $request): Response
    {
        ...
        */
        ...
        // -------------------------------------------------------------------------
        $queryBuilder = $em->getRepository("sgvDashboardBundle:Tbl17Proveedores")->createQueryBuilder('reg');
        ...
        $deleteFormAjax = $this->createCustomForm(':REG_ID', 'DELETE', 'sgv_suppliers_delete');
    ...
    {
        $form = $this->createForm(new Tbl17ProveedoresType(), $entity, array(
            'action' => $this->generateUrl('sgv_suppliers_create'),
            'method' => 'POST'
        ));
        return $form;
    }
    ...
    public function createAction(Request $request): Response
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirectToRoute('sgv_suppliers_index');
        }
    ...
    public function editAction($id): Response
    {
        ...
        */
        $em = $this->entityManager;
        $suppliers = $em->getRepository('sgvDashboardBundle:Tbl17Proveedores')->find($id);
    ...
    {
        $form = $this->createForm(new Tbl17ProveedoresType(), $entity, array('action' => $this->generateUrl('sgv_suppliers_update', array('id' => $entity->getidProveedor())), 'method' => 'PUT'));
    ...
    public function updateAction($id, Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('mensaje', $successMessage);
            return $this->redirectToRoute('sgv_suppliers_index', array('id' => $suppliers->getidProveedor()));
        }
        return $this->render('dashboard/Suppliers/edit.html.twig', array('supplier' => $suppliers, 'form' => $form->createView()));
    }
...
//ELIMINAR REGISTRO
    ...
    public function deleteAction(Request $request, $id): Response
    {
        ...
        $form = $this->createCustomForm($suppliers->getidProveedor(), 'DELETE', 'sgv_suppliers_delete');
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            /*
                    $allSuppliers = $em->getRepository('sgvDashboardBundle:Tbl17Proveedores')->findAll();
