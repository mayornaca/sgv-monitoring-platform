...
!function(e) {
    ...
    e.FileDialog = function(a) {
        var o = e.extend(e.FileDialog.defaults, a)
            , t = e(["<div class='modal fade'>", "    <div class='modal-dialog file_upload_dialog'>", "        <div class='modal-content'>", "            <div class='modal-header'>", "                <button type='button' class='close' data-dismiss='modal'>", "                    <span aria-hidden='true'>&times;</span>", "                    <span class='sr-only'>", o.cancel_button, "                    </span>", "                </button>", "                <h4 class='modal-title'>", o.title, "                </h4>", "            </div>", "            <div class='modal-body'>", "                <input type='file' style='display: none;' />", "                <div class='bfd-dropfield'>", "                    <div class='bfd-dropfield-inner'>", o.drag_message, "                    </div>", "                </div>", "                <div class='container-fluid bfd-files'>", "                </div>", "            </div>", "            <div class='modal-footer'>", "                <button type='button' class='btn btn-primary bfd-ok'>", o.ok_button, "                </button>", "                <button type='button' class='btn btn-default bfd-cancel'", "                                data-dismiss='modal'>", o.cancel_button, "                </button>", "            </div>", "        </div>", "    </div>", "</div>"].join(""))
            , n = !1
            , r = e("input:file", t)
            , i = e(".bfd-dropfield", t)
        ...
        var d = []
            ...
            l.push(i),
                ...
                i.onload = function(e) {
                    ...
                    var x = $.Event("onload.bs.filedialog");
                    x.files = d,
                        t.trigger(x)
                }
                ,
            ...
            n = e(".progress-bar", s),
                ...
                r = e("<div class='row' id='up_file_row_"+ix+"' data-file_id='-' data-id_pt='-' data-fileindex='"+ix+"' data-file_name_original='-' data-file_name_fisic='-' data-path='-' data-reg_status='-' data-created_by='-' data-create_at='-' data-deleted_restored_by='-' data-deleted_restored_at='-'                                                   ></div>"),
                r.append(s),
        ...
        return r.change(function(e) {
            ...
            //console.log(a);
            /*var x = $.Event("changefile.bs.filedialog");
            x.files = a;
            t.trigger(x);*/
            f(a);
            var o = r.clone(!0);
        ...
        e.FileDialog.defaults = {
            ...
            drag_message: "Arrastra archivos aquí",
            dropheight: 190,
            error_message: "Ocurrió un error mientras se cargaban los archivos",
            multiple: true,
            ok_button: "OK",
            // file reading mode.
            // BinaryString, Text, DataURL, ArrayBuffer
            readAs: "DataURL",
            remove_message: "Quitar&nbsp;archivo",
